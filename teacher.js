...
(function () {
  ...
  function renderTeacher() {
    ...
    html += '<div class="hero"><h1>교사용 전체 미리보기<small>TEACHER CONSOLE · ANSWER KEY · QR</small></h1><p>모든 증거의 정답, 감식 결과, 추론 질문과 카드 뒷면용 QR을 한눈에 확인합니다. 이 페이지 주소는 학생에게 공개하지 않습니다.</p></div>';
